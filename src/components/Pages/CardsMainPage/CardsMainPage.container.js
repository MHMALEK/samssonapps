...
import { getCardsAction, goToCardListAction } from "../../../store/Modules/Cards/Actions";
...
class CardsMainPage extends React.Component {
  ...
  render() {
    ...
    return <CardsMainPagePresentation history={history} cardsList={cardsList} goTobuyCardPageHandler={this.goTobuyCardPage} />;
  }
}
